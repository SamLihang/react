            ...
            <BCTouchable onPress={() => {this._goDetail(ProductId)}}>
                <View style={[styles.listItem, gs.bgc_fff]}>
                    ...
                    <View style={styles.listItemRight}>
                        <View style={[styles.listItemRightTop,{flexDirection:'row',justifyContent:'space-between'}]}>
                            <BCText
                                style={[gs.fts_15, gs.c_3a3838]}>{substr(product.ProductName, 10)}</BCText>
...
export default class ProductsSearch extends PageComponent {
    _Products = {};
    _Bottom = {};
    _Tab = null;
    _HorizontalTab = null;
