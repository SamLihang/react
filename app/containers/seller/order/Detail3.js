/**
 * Created by Administrator on 2017/4/10.待验货
 */
...
class Detail3 extends PullViewComponent {
    //设置页面标题
    setTitle() {
        return "订单详情(待验货)"
    }
...
const connectDetail3 = connect(mapStateToProps)(Detail3);
connectDetail3.navigationOptions = NavigationOptions;
export default connectDetail3;