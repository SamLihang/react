...
export default class TakeCashProblem extends PullViewComponent {
    //设置页面标题
    setTitle() {
        return "问题详情"
    }
            ...
            <View style={[Styles.main, gs.bgc_f2f1ef]}>
                <View style={[gs.bgc_fff,Styles.main]}>
                    <View style={Styles.titleStyle}>
                        ...
                        <BCText style={[gs.fts_14,gs.c_3a3838,{marginLeft:px2dp(7)}]}>如何提现</BCText>
                    </View>
                    <View style={Styles.answerStyle}>
                        <BCImage style={{marginLeft:px2dp(12)}} source={require('../../../../imgs/Answer.png')}></BCImage>
                        <View>
                            <BCText style={[gs.fts_14,gs.c_888,{marginLeft:px2dp(7)}]}>打开并登录报菜郎APP，进入首页后点击“我的”页面中的“我的余额”，进入后点击“提现”按钮，输入预提现金额，点击“下一步”按钮输入提现密码即可成功提现。</BCText>
                        </View>
                    </View>
                </View>
            </View>
