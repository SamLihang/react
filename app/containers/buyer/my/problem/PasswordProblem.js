...
export default class PasswordProblem extends PullViewComponent {
    //设置页面标题
    setTitle() {
        return "问题详情"
    }
            ...
            <View style={[Styles.main, gs.bgc_f2f1ef]}>
                <View style={[gs.bgc_fff,Styles.main]}>
                    <View style={Styles.titleStyle}>
                        ...
                        <BCText style={[gs.fts_14,gs.c_3a3838,{marginLeft:px2dp(7)}]}>忘记密码怎么办</BCText>
                    </View>
                    <View style={Styles.answerStyle}>
                        <BCImage style={{marginLeft:px2dp(12)}} source={require('../../../../imgs/Answer.png')}></BCImage>
                        <View>
                            <BCText style={[gs.fts_14,gs.c_888,{marginLeft:px2dp(7)}]}>打开报菜郎APP，点击“忘记密码”进入“找回密码”页面，根据操作提示完成相关操作即可完成密码找回。</BCText>
                        </View>
                    </View>
                </View>
            </View>
