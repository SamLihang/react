...
export default class LookUpProblem extends PullViewComponent {
    //设置页面标题
    setTitle() {
        return "问题详情"
    }
            ...
            <View style={[Styles.main, gs.bgc_f2f1ef]}>
                <View style={[gs.bgc_fff,Styles.main]}>
                    <View style={Styles.titleStyle}>
                        ...
                        <BCText style={[gs.fts_14,gs.c_3a3838,{marginLeft:px2dp(7)}]}>如何查找想要的商品</BCText>
                    </View>
                    <View style={Styles.answerStyle}>
                        <BCImage style={{marginLeft:px2dp(12)}} source={require('../../../../imgs/Answer.png')}></BCImage>
                        <View>
                            <BCText style={[gs.fts_14,gs.c_888,{marginLeft:px2dp(7)}]}>打开并登录报菜郎APP进入到首页，点击页面顶部搜索框，输入菜品名称即可完成搜索。</BCText>
                        </View>
                    </View>
                </View>
            </View>
