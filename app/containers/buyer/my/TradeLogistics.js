...
import {StyleSheet, View, TextInput, ListView, Image, Text,Platform} from 'react-native';
import {
    BCImage,
    BCTouchable,
    BCText,
...
class TradeLogistics extends PullListComponent {
    constructor(props) {
        super(props);
        this.state = {
            dataSource: []
    ...
    // content() {
    //     let {ReduceTradeLogistics} = this.props;
    //     if (ReduceTradeLogistics.datas.length > 0) {
    ...
    //                         return (
    //                             <View key={index} style={[gs.bgc_f2f1ef]}>
    //                                 <BCTouchable onPress={() => {
    ...
    //                                                 break;
    //                                         }
    //                                         this.push('PurchaseOrderList', {initialPage: initialPage})
    //                                     }
...
const connectTradeLogistics = connect(mapStateToProps)(TradeLogistics);
