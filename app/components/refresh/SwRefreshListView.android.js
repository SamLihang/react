    ...
    if (this.state.loadStatus == LoadMoreStatus.noMoreData){
      return(
        <View>
          ...
          <View style={footStyles.footer}>
            <BCText style={footStyles.footerText}>{this.props.noMoreDataTitle}</BCText>
          </View>
        </View>
      ...
      return(
        <View>
          ...
          <View style={footStyles.footer}>
            {/*<ActivityIndicator/>*/}
            <BCText style={footStyles.footerText}>{this.props.pusuToLoadMoreTitle}</BCText>
          </View>
        </View>
      )
      ...
      return(
        <View>
          ...
          <View style={footStyles.footer}>
            <ActivityIndicator/>
            <BCText style={footStyles.footerText}>{this.props.loadingTitle}</BCText>
          </View>
        </View>
      )
    ...
    return(
      ...
      <View style={defaultHeaderStyles.background}>
        <View style={defaultHeaderStyles.status}>
          ...
          <BCText style={defaultHeaderStyles.statusTitle}>{this.state.refreshTitle}</BCText>
        </View>
        <BCText style={defaultHeaderStyles.date}>{'上次更新时间:'+this.state.date}</BCText>
      </View>
    )
  }
